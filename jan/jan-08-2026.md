...
3. Entertainment: Text
    ...
    ```java
     public Entertainment[] getEntertainments(String text) throws SQLException, EntertainmentNotFoundException {
         return new VisualEntertainment(getEntertainment(id));
     }
    ```
...
10. [How to use SQLite DB Browser for Efficient Database Management](https://www.w3resource.com/sqlite/snippets/sqlite-db-browser-guide.php) (DB Browser to run SQL Statements) from W3Resources
